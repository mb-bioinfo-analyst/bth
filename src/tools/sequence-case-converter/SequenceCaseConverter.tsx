...
atgcGTACgtagctAGCT`);
  ...
  return(
    ...
    <ToolLayout
  title="Sequence Case Converter"
  description="Convert DNA, RNA or protein sequences between uppercase, lowercase or toggle case while preserving FASTA headers."
  badge="Sequence Tool"
