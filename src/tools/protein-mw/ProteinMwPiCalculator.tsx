...
MKWVTFISLLFLFSSAYS`);
  ...
  return (
    ...
    <ToolLayout
  title="Protein Molecular Weight & pI Calculator"
  description="Calculate protein molecular weight, isoelectric point (pI), amino acid composition, and extinction coefficient."
  badge="Protein Tool"
  slug="protein-mw"
